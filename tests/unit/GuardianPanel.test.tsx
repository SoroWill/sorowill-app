...
describe('GuardianPanel', () => {
  it('shows empty state when no guardians', () => {
    renderWithProviders(<GuardianPanel guardians={[]} guardianVotes={0} />);
  ...
  it('renders guardian addresses', () => {
    ...
    renderWithProviders(<GuardianPanel guardians={[addr1, addr2]} guardianVotes={0} />);
  ...
  it('displays vote count', () => {
    ...
    renderWithProviders(<GuardianPanel guardians={guardians} guardianVotes={1} />);
  ...
  it('clamps displayed votes to threshold', () => {
    ...
    renderWithProviders(<GuardianPanel guardians={guardians} guardianVotes={5} />);
  ...
  it('shows a warning when guardian count is below quorum threshold', () => {
    ...
    renderWithProviders(<GuardianPanel guardians={guardians} guardianVotes={0} />);
  ...
  it('shows a quorum-unreachable warning when guardian count is below threshold', () => {
    ...
    renderWithProviders(<GuardianPanel guardians={[guardian]} guardianVotes={0} />);
